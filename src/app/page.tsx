    ...
    <div className="min-h-screen bg-[var(--background)] antialiased transition-colors duration-300">
          ...
          <div className="flex items-center gap-4">
            <nav className="hidden items-center gap-2 md:flex">
              <a
                ...
                className="group relative px-4 py-2 text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--muted-foreground)] transition-all hover:text-[var(--primary)]"
              >
            ...
            <Link
              href="/login"
              className="hidden text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--muted-foreground)] hover:text-[var(--primary)] transition-colors sm:block"
            >
              ENTRAR
            </Link>
            <Link
              href="/signup"
              className="rounded-none border border-[var(--primary)] bg-[var(--primary)]/10 px-6 py-2.5 text-xs font-mono font-bold uppercase tracking-widest text-[var(--primary)] shadow-[0_0_15px_rgba(0,255,204,0.2)] hover:bg-[var(--primary)]/20 hover:shadow-[0_0_20px_rgba(0,255,204,0.4)] transition-all duration-300"
            >
              Começar agora
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden pt-12 pb-24 sm:pt-20 sm:pb-32 data-grid">
        ...
        <div className="relative mx-auto max-w-6xl px-6 text-center" style={{ zIndex: 10 }}>
          <div className="mx-auto max-w-4xl">
            <div className="mb-8 inline-flex items-center gap-2.5 border border-[var(--primary)]/30 bg-[var(--primary)]/10 px-4 py-2 text-xs font-mono font-bold text-[var(--primary)] uppercase tracking-widest">
            ...
            <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <Link
                href="/signup"
                className="group btn-neon inline-flex items-center gap-2 rounded-none border border-[var(--primary)] bg-[var(--primary)]/10 px-8 py-4 text-sm font-mono font-bold uppercase tracking-widest text-[var(--primary)] shadow-[0_0_15px_rgba(0,255,204,0.2)] transition-all duration-300 hover:bg-[var(--primary)]/20 hover:shadow-[0_0_30px_rgba(0,255,204,0.4)]"
              >
                [ INICIAR_SISTEMA ]
              ...
              <Link
                href="/login"
                className="btn-neon inline-flex items-center gap-2 rounded-none border border-[var(--border)] bg-transparent px-8 py-4 text-sm font-mono font-bold uppercase tracking-widest text-[var(--foreground)] transition-all duration-300 hover:border-[var(--primary)]/50 hover:bg-white/5"
              >
                &gt; ACESSAR_CONTA
              </Link>
            </div>
          ...
          <div className="mx-auto mt-20 grid max-w-4xl grid-cols-2 gap-4 sm:grid-cols-4">
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-3xl font-extrabold text-white group-hover:scale-105 transition-transform duration-300 text-glow-cyan font-mono">
                  {stat.number}
                </div>
                <div className="mt-2 text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--muted-foreground)]">
                  {stat.label}
                </div>
            ...
            <div className="p-8 text-left">
              ...
              <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-[var(--primary)]/20 pb-4">
                ...
                <div className="flex items-center gap-2 border border-[var(--primary)]/30 bg-[var(--primary)]/10 px-3 py-1.5 glow-cyan">
                  ...
                  <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--primary)]">ESTE MÊS</span>
                </div>
              </div>
                ...
                {[
                  ...
                  <div key={i} className="hud-border bg-[#0B1221]/80 p-5 relative overflow-hidden group">
                    ...
                    <div className="mb-3 flex items-center justify-between">
                      <span className="text-[10px] font-bold font-mono uppercase tracking-widest text-[var(--muted-foreground)]">{kpi.label}</span>
              ...
              <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                <div className="hud-border bg-[#0B1221]/80 p-6 lg:col-span-2">
                  <h4 className="mb-6 text-[10px] font-bold font-mono text-[var(--muted-foreground)] uppercase tracking-widest border-b border-white/5 pb-2">FLUXO DE CAIXA</h4>
                  ...
                  <div className="mt-4 flex justify-between text-[9px] font-bold font-mono text-[var(--primary)] opacity-60 uppercase">
                ...
                <div className="hud-border bg-[#0B1221]/80 p-6 flex flex-col justify-between">
                  <h4 className="mb-4 text-[10px] font-bold font-mono text-[var(--muted-foreground)] uppercase tracking-widest border-b border-white/5 pb-2">DISTRIBUIÇÃO</h4>
                  <div className="flex flex-1 items-center justify-center py-4">
                    <div className="relative h-32 w-32 drop-shadow-[0_0_10px_var(--primary)]">
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center">
                        <span className="text-xs font-bold font-mono text-[var(--foreground)]">50/50</span>
                        <span className="text-[8px] font-mono text-[var(--primary)]">RATIO</span>
                      </div>
                    </div>
                  </div>
                  <div className="flex justify-center gap-4 text-[9px] font-bold font-mono uppercase tracking-widest">
      ...
      <section id="funcionalidades" className="relative border-t border-[var(--primary)]/20 bg-[#050B14] py-24 sm:py-32">
        ...
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="text-center max-w-3xl mx-auto">
            <div className="mb-4 inline-flex items-center gap-2 border border-[var(--primary)]/30 bg-[var(--primary)]/10 px-4 py-1.5 text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--primary)]">
          ...
          <div className="mt-20 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--primary)]">
                  {feature.title}
                </h3>
                <p className="mt-3 text-xs font-mono leading-relaxed text-[var(--muted-foreground)]">
                  {feature.description}
                </p>
            ...
            {steps.map((step, index) => (
              <div key={step.step} className={`relative group text-center px-4 animate-fade-in-up delay-${(index + 1) * 200}`}>
                <div className="relative mx-auto mb-8">
                  ...
                  <div className="absolute -right-2 -top-2 flex h-6 w-6 items-center justify-center bg-[var(--primary)] text-[10px] font-mono font-black text-[#020617] shadow-[0_0_15px_var(--primary)]">
                    {step.step}
                  </div>
                </div>
                <h3 className="text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--primary)] text-glow-cyan">
                  {step.title}
                </h3>
                <p className="mt-3 text-xs font-mono leading-relaxed text-[var(--muted-foreground)]">
                  {step.description}
        ...
        <div className="relative mx-auto max-w-6xl px-6">
          ...
          <div className="mt-20 grid gap-8 sm:grid-cols-3">
            <div className="group hud-border bg-[#0B1221]/80 p-8 text-center scanline-overlay animate-fade-in-up delay-100">
              ...
              <h3 className="text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--success)] text-glow-green">Sua privacidade garantida</h3>
              <p className="mt-3 text-xs font-mono leading-relaxed text-[var(--muted-foreground)]">
            ...
            <div className="group hud-border bg-[#0B1221]/80 p-8 text-center scanline-overlay animate-fade-in-up delay-200">
              ...
              <h3 className="text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--primary)] text-glow-cyan">Agilidade e Sem Fricção</h3>
              <p className="mt-3 text-xs font-mono leading-relaxed text-[var(--muted-foreground)]">
            ...
            <div className="group hud-border bg-[#0B1221]/80 p-8 text-center scanline-overlay animate-fade-in-up delay-300">
              ...
              <h3 className="text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--warning)] text-glow-yellow">Relatórios Visuais</h3>
              <p className="mt-3 text-xs font-mono leading-relaxed text-[var(--muted-foreground)]">
        ...
        <div className="mx-auto max-w-6xl px-6 relative z-10">
          ...
          <div className="grid gap-8 sm:grid-cols-2 max-w-4xl mx-auto items-stretch">
            ...
            <div className="flex flex-col justify-between hud-border bg-[#0B1221]/80 backdrop-blur-md p-8 transition-all hover:border-[var(--primary)]/50 scanline-overlay">
              <div>
                <div className="mb-6">
                  <h3 className="text-lg font-mono font-bold uppercase tracking-widest text-[var(--muted-foreground)]">NÍVEL 1: BÁSICO</h3>
                  <p className="text-[10px] font-mono text-[var(--muted-foreground)]/60">Recursos fundamentais</p>
                </div>
                <div className="mb-8">
              ...
              <Link
                href="/signup"
                className="block w-full border border-[var(--border)] bg-transparent py-3.5 text-center text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--foreground)] transition-all hover:bg-white/5 hover:border-[var(--primary)]/50 hover:shadow-[0_0_15px_rgba(0,255,204,0.1)]"
              >
                CRIAR_CONTA_GRÁTIS
              </Link>
            </div>
            ...
            <div className="relative flex flex-col justify-between hud-border border-[var(--primary)] bg-[#0B1221] p-8 shadow-[0_0_25px_rgba(0,255,204,0.15)] scanline-overlay">
              ...
              <div>
                <div className="mb-6">
                  <h3 className="text-lg font-mono font-bold uppercase tracking-widest text-[var(--primary)] text-glow-cyan">NÍVEL 2: PRO</h3>
                  <p className="text-[10px] font-mono text-[var(--primary)]">Ideal para autônomos e freelancers</p>
                </div>
                <div className="mb-8">
                  <div className="flex items-baseline gap-1 font-mono">
              ...
              <Link
                href="/signup"
                className="flex items-center justify-center gap-2 w-full border border-[var(--primary)] bg-[var(--primary)]/10 py-3.5 text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--primary)] transition-all hover:bg-[var(--primary)]/20 hover:shadow-[0_0_25px_rgba(0,255,204,0.3)]"
              >
                ASSINAR_PLANO_PRO
      ...
      <section className="relative overflow-hidden py-24 border-t border-[var(--primary)]/20">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <Link
            href="/signup"
            className="mt-12 btn-neon inline-flex items-center gap-2 border border-[var(--primary)] bg-[var(--primary)]/10 px-10 py-4 text-xs font-mono font-bold uppercase tracking-widest text-[var(--primary)] transition-all duration-300 hover:bg-[var(--primary)]/20 hover:shadow-[0_0_40px_rgba(0,255,204,0.4)]"
          >
            [ COMEÇAR AGORA MESMO ]
            <ArrowRight className="h-4 w-4" />
          </Link>
        ...
        <div className="mx-auto max-w-6xl px-6 py-16">
          <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <p className="mt-6 text-[10px] font-mono uppercase tracking-widest leading-relaxed text-[var(--muted-foreground)]">
                A ferramenta mais simples e inteligente para separar as contas pessoais e corporativas de empreendedores individuais.
              </p>
            </div>
            <div>
              <h4 className="text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--primary)]">Produto</h4>
              <ul className="mt-4 space-y-3">
                <li><Link href="#como-funciona" className="text-[10px] font-mono uppercase tracking-widest text-[var(--muted-foreground)] hover:text-[var(--primary)] transition-colors">Como funciona</Link></li>
                <li><Link href="#planos" className="text-[10px] font-mono uppercase tracking-widest text-[var(--muted-foreground)] hover:text-[var(--primary)] transition-colors">Preços</Link></li>
                <li><Link href="/login" className="text-[10px] font-mono uppercase tracking-widest text-[var(--muted-foreground)] hover:text-[var(--primary)] transition-colors">Segurança</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--primary)]">Suporte</h4>
              <ul className="mt-4 space-y-3">
                <li><Link href="/login" className="text-[10px] font-mono uppercase tracking-widest text-[var(--muted-foreground)] hover:text-[var(--primary)] transition-colors">Central de Ajuda</Link></li>
                <li><Link href="/login" className="text-[10px] font-mono uppercase tracking-widest text-[var(--muted-foreground)] hover:text-[var(--primary)] transition-colors">Fale Conosco</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-[10px] font-mono font-bold uppercase tracking-widest text-[var(--primary)]">Legal</h4>
              <ul className="mt-4 space-y-3">
                <li><Link href="/login" className="text-[10px] font-mono uppercase tracking-widest text-[var(--muted-foreground)] hover:text-[var(--primary)] transition-colors">Termos de Uso</Link></li>
                <li><Link href="/login" className="text-[10px] font-mono uppercase tracking-widest text-[var(--muted-foreground)] hover:text-[var(--primary)] transition-colors">Políticas de Privacidade</Link></li>
              </ul>
            </div>
          </div>
          <div className="mt-16 border-t border-[var(--primary)]/20 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-[9px] font-mono uppercase tracking-widest text-[var(--muted-foreground)]">
              &copy; {new Date().getFullYear()} CertoFin. Todos os direitos reservados.
            </p>
            <p className="text-[9px] font-mono uppercase tracking-widest text-[var(--primary)] font-bold text-glow-cyan pulse-dot">
