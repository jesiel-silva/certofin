  ...
  return (
    <div className="flex min-h-screen bg-[var(--background)]">
      ...
      <div className="relative hidden w-0 lg:block lg:w-1/2 overflow-hidden lg:flex lg:flex-col lg:justify-center lg:px-12 xl:px-20">
        ...
        <div className="absolute top-32 right-20 h-64 w-64 rounded-full bg-[var(--primary)]/10 blur-3xl" />
        <div className="absolute bottom-32 left-20 h-80 w-80 rounded-full bg-[var(--primary)]/5 blur-3xl" />
