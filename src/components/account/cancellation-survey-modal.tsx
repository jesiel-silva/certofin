...
export function CancellationSurveyModal({
  ...
  return (
    <Dialog
      open={isOpen}
      onClose={handleReset}
      className="max-w-xl hud-border bg-[#0B1221]/95 text-[var(--foreground)] backdrop-blur-xl p-0 shadow-2xl flex flex-col max-h-[90vh] overflow-hidden"
    >
      {/* Cabeçalho Fixo */}
      <div className="flex items-center justify-between border-b border-[var(--primary)]/20 px-6 py-4 bg-[var(--background)]/80 shrink-0 z-10">
      ...
      {/* Conteúdo com Rolagem Flexível */}
      <div className="p-6 space-y-6 overflow-y-auto flex-1 max-h-[calc(90vh-70px)]">
        {/* Indicador de passos */}
